...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.webcam_area.setStyleSheet(
        ...
        self.chat_log_area.setStyleSheet(
            "background-color: #f0f0f0; border: 1px solid #ccc;"
        )
        self.bottom_section_layout.addWidget(
            self.chat_log_area, stretch=2
        )  # Give it more space than input
        ...
        self.main_layout.addLayout(
            self.bottom_section_layout, stretch=1
        )  # Takes less space
